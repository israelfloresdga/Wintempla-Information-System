#pragma once   //_____________________________________________ DepartmentDlg.h  
#include "resource.h"

class DepartmentDlg: public Win::Dialog
{
public:
	DepartmentDlg()
	{
...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy = Sys::Convert::PixelToDlgUnitY(101);
	...
	void InitializeGui()
	{
		...
		btOK.Create(NULL, L"OK", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_DEFPUSHBUTTON | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 82, 53, 80, 28, hWnd, 1002);
		btCancel.Create(NULL, L"Cancel", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 189, 53, 80, 28, hWnd, 1003);
