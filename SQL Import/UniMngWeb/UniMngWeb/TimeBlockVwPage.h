#pragma once   //_____________________________________________ TimeBlockVwPage.h  
#include "resource.h"

class TimeBlockVwPage: public Web::Page
{
public:
	TimeBlockVwPage()
	{
...
private:
	...
	Web::Button btDelete;
	Web::Button btHome;
	Web::ListView lvTime_block;
	Web::HiddenValue hdTime_blockID;
protected:
	void InitializeGui()
	{
		this->ID=L"TimeBlockVwPage";
		this->Title=L"TimeBlockVwPage";
		this->CssFile=L"cyan.css";
		this->JavascriptFile=L"TimeBlockVwPage.js";
		this->btInsert.ID=L"btInsert";
		this->btEdit.ID=L"btEdit";
		this->btDelete.ID=L"btDelete";
		this->btHome.ID=L"btHome";
		this->lvTime_block.ID=L"lvTime_block";
		...
		this->lvTime_block.cssClass=L"Data";
		this->lvTime_block.Height=10;
		this->lvTime_block.FontSize=16;
		this->AddChild(btInsert);
		this->AddChild(btEdit);
		this->AddChild(btDelete);
		this->AddChild(btHome);
		this->AddChild(lvTime_block);
