...
#define DSN L"dsn_university_sql_import"
#define USERNAME L"root"
#define PASSWORD L"123"
#define CONNECTION_STRING L"DRIVER={SQL Server};server=ISRAELLSMT_M\\SQLEXPRESS;database=university_sql_import;Trusted_Connection=yes"
