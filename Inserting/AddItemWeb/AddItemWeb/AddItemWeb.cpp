#include "stdafx.h"  //________________________________________ AddItemWeb.cpp
#include "AddItemWeb.h"
#include "ItemPage.h"
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "AddItemWeb ISAPI Extension");
...
void SelectWindow(const wchar_t* windowID, Web::HttpConnector& h)
{
	...
	else if(wcscmp(windowID, L"ItemPage") == 0) {ItemPage page; page.Run(h);}
}
