...
protected:
	...
	void InitializeGui()
	{
		...
		tbxOutput.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_MULTILINE | ES_WANTRETURN | ES_LEFT | ES_WINNORMALCASE, 7, 9, 582, 436, hWnd, 1000);
		fontArial014A.Create(L"Arial", 14, false, false, false, false);
		tbxOutput.Font = fontArial014A;
	}
	//_________________________________________________
