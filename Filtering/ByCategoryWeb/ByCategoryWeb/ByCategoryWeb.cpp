#include "stdafx.h"  //________________________________________ ByCategoryWeb.cpp
#include "ByCategoryWeb.h"
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "ByCategoryWeb ISAPI Extension");
