#include "stdafx.h"  //________________________________________ ByMulBrandWeb.cpp
#include "ByMulBrandWeb.h"
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "ByMulBrandWeb ISAPI Extension");
