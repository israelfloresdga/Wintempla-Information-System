...
#define DSN L"dsn_circuit_city_sharing"
#define USERNAME L"root"
#define PASSWORD L"123"
#define CONNECTION_STRING L"DRIVER={SQL Server};server=ISRAELLSMT_M\\SQLEXPRESS;database=circuit_city_sharing;Trusted_Connection=yes"
