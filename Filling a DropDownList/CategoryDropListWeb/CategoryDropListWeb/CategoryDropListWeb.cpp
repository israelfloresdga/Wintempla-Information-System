#include "stdafx.h"  //________________________________________ CategoryDropListWeb.cpp
#include "CategoryDropListWeb.h"
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "CategoryDropListWeb ISAPI Extension");
