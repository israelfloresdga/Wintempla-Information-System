#include "stdafx.h"  //________________________________________ CategoryManagerWeb.cpp
#include "CategoryManagerWeb.h"
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "CategoryManagerWeb ISAPI Extension");
...
void SelectWindow(const wchar_t* windowID, Web::HttpConnector& h)
{
	...
	else if(wcscmp(windowID, L"CategoryPage") == 0) {CategoryPage page; page.Run(h);}
}
