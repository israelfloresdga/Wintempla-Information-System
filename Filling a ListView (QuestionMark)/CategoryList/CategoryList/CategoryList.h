...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy = Sys::Convert::PixelToDlgUnitY(483);
	...
	void InitializeGui()
	{
		...
		lvCategory.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | LVS_ALIGNLEFT | LVS_REPORT, 11, 11, 356, 452, hWnd, 1000);
